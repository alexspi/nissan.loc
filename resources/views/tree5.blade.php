...
<head>
    ...
    <style type="text/css">
        ...
        *:first-child+html .cf { zoom: 1; }
        ...
        #nestable-menu,#nestable-menu2 { padding: 0; margin: 20px 0; }
...
<p><strong><a href="https://github.com/dbushell/Nestable">Code on GitHub @dbushell</a></strong></p>
<p><strong><a href="https://github.com/NalinSajwan/nalinsajwan.github.io">Code on GitHub @NalinSajwan</a></strong></p>
...
<p><strong>Draggable Handles with Text fields and click events</strong> (updated by <a href="https://in.linkedin.com/in/nalinsajwan">Nalin Sajwan</a>)</p>
...
<ul class="myContent">
    <li>Added new button <b>Add Row</b>, clicking it will add a new row at the end of nestable list below.</li>
    <li>Updated html to support following -
        <ol>
            <li>Input field - added this because mostly nestable is used with some stored data.</li>
            <li>Links -
                <div>
                    <div>&nbsp;</div>
                    <div>
                            <span>
                                <a title="Add Row Above" class="arrow-up" style="float:left;"></a>
                            </span>
                        <span style="padding-left:10px;">
                                <b> Add Row Above</b> - this will add a new row just below from where it is called, it will be very useful when using a hierarchical structure.
                            </span>
                    </div>
                    <div>&nbsp;</div>
                    <div>
                            <span>
                                <a title="Add Row Below" class="arrow-down" style="float:left;"></a>
                            </span>
                        <span style="padding-left:10px;">
                                <b> Add Row Below</b> - this will add a new row just below from where it is called, it is also very useful for hierarchical structure.
                            </span>
                    </div>
                    <div>&nbsp;</div>
                    <div>
                            <span style="padding-left:5px;">
                                <a title="Remove Row" class="removeButton">X</a>
                            </span>
                        <span style="padding-left:15px;">
                                <b> Remove Row</b> - this will remove the row from where it is called.
                            </span>
                    </div>
                </div>
            </li>
...
<p><strong>Serialised Output with input data (per list)</strong></p>
