...
@section('breadcrumbs')
    <div class="breadcum">
        ...
        {!! Breadcrumbs::render('pgspares1',$mark,$model,$modifs,$maintree,$parentNodeId,$SubGroupNodeId,$GroupNodeId) !!}
    </div>
@stop
                ...
                <table class="table table--group mx-0 mx-xl-auto">
                    ...
                    @foreach( $Spares AS $Spare )
                        <tr>
                            ...
                            <td> <a class="catLink__link" href="{!!route('pgsparesinfo1',[$mark,$model,$modifs,$maintree,$parentNodeId,$SubGroupNodeId,$GroupNodeId,$Spare['articleId'],$Spare['articleLinkId'],$Spare['brandName']])!!}">Подробности </a> </td>
                            <td></td>
                        </tr>
                    @endforeach
                    </tbody>
